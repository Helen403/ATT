...
-(instancetype)initWithViewModel:(id<HViewModelProtocol>)viewModel{
    ...
    self.moveViewModel = (MoveViewModel *)viewModel;
...
-(void)h_bindViewModel{
    [[self.moveViewModel.tableViewSubject takeUntil:self.rac_willDeallocSignal] subscribeNext:^(NSNumber *x) {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            self.tableView.frame = CGRectMake(0, 0, SCREEN_WIDTH*0.8, [self h_w:40]*(self.moveViewModel.arr.count+1));
