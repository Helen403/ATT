...
@interface ProcessedController ()<ZJScrollPageViewDelegate>
...
@implementation ProcessedController
...
-(NSMutableArray<HViewController<ZJScrollPageViewChildVcDelegate> *> *)childVcs{
    if (!_childVcs) {
        ...
        [_childVcs addObject:[[ApproveController alloc] init]];
        [_childVcs addObject:[[DealWithController alloc] init]];
    }
    return _childVcs;
}
