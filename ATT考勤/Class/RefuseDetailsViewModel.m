...
@implementation RefuseDetailsViewModel
#pragma mark private
-(void)h_initialize{
    ...
    if (!_refreshDataCommand) {
        ...
        _refreshDataCommand = [[RACCommand alloc] initWithSignalBlock:^RACSignal *(id input) {
            ...
            return [RACSignal createSignal:^RACDisposable *(id<RACSubscriber> subscriber) {
                ...
                RefuseModel *alreadyTreatmentModel = self.lateArr[self.indexTmp];
                ...
                [self SOAPData:findFormByApplyId soapBody:body1 success:^(NSString *result1) {
                    ...
                    RefuseDetailsModel *refuseDetailsModel = [RefuseDetailsModel mj_objectWithKeyValues:xmlDoc1];
                    self.refuseDetailsModel = refuseDetailsModel;
                    NSString *body2 =[NSString stringWithFormat: @"<findFlowStepCheckById xmlns=\"http://service.webservice.vada.com/\">\
                                      ...
                                      </findFlowStepCheckById>",self.companyCode,refuseDetailsModel.flowInstanceId];
