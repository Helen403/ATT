...
#import "HViewModel.h"
#import "AlreadyDetailsModel.h"

@interface AlreadyDetailsViewModel : HViewModel
...
@property(nonatomic,strong) AlreadyDetailsModel *alreadyDetailsModel;
