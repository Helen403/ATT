...
#define MAIN_PAN_RED RGBCOLOR(247,37,37)

#define MAIN_PAN_2 RGBCOLOR(29, 29, 29)

#define MAIN_PAN_3 RGBCOLOR(171, 171, 171)

#define MAIN_TEXTFIELD RGBCOLOR(176,176,176)

#define MAIN_ENABLE RGBCOLOR(176, 176, 176)

#define MAIN_GREED RGBCOLOR(138, 176, 127)

#define MAIN_RED RGBCOLOR(211,68,29)
...
#define XCFTabBarNormalColor RGBCOLOR(107, 107, 107)         // TabBar颜色
