...
-(void)setMonthModel:(MonthModel *)monthModel{
    ...
    self.offWork.text = [NSString stringWithFormat:@"本月请假次数:%@次",monthModel.offWorkCount] ;

    self.outWork.text = [NSString stringWithFormat:@"本月出差次数:%@次",monthModel.outWorkCount] ;
    
    self.overWork.text = [NSString stringWithFormat:@"本月加班次数:%@次",monthModel.overWorkCount] ;
