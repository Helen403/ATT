...
#import "ContrastCellView.h"

@interface ContrastCellView()
...
@implementation ContrastCellView
...
-(void)setContrastModel:(ContrastModel *)contrastModel{
    if (!contrastModel) {
        return;
    }
    _contrastModel = contrastModel;
    self.title.text = contrastModel.title;
    self.current.text = contrastModel.current;
