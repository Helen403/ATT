...
@implementation CompanyWeekCellView
...
-(void)setCompanyWeekModel:(CompanyWeekModel *)companyWeekModel{
    if (!companyWeekModel) {
        return;
    }
    _companyWeekModel = companyWeekModel;
    self.time.text =[NSString stringWithFormat:@"%@(%@-%@)",companyWeekModel.week,[LSCoreToolCenter getFormatter:companyWeekModel.startDate],[LSCoreToolCenter getFormatter:companyWeekModel.endDate]];
    self.team.text = [NSString stringWithFormat:@"%@",companyWeekModel.deptName];
    self.attend.text = [NSString stringWithFormat:@"出勤率为%.2f%%",companyWeekModel.normalRate.floatValue] ;
    self.lateWorkCount.text = [NSString stringWithFormat:@"迟到:%@人",companyWeekModel.lateWorkCount];
    self.earlyWorkCount.text = [NSString stringWithFormat:@"早退:%@人",companyWeekModel.earlyWorkCount];
    self.forgetWorkCount.text = [NSString stringWithFormat:@"漏打卡:%@人",companyWeekModel.forgetWorkCount];
    self.goOutWorkCount.text = [NSString stringWithFormat:@"外出:%@人",companyWeekModel.goOutWorkCount];
    self.offWorkCount.text = [NSString stringWithFormat:@"请假:%@人",companyWeekModel.offWorkCount];
    self.overWorkCount.text = [NSString stringWithFormat:@"加班:%@人",companyWeekModel.overWorkCount];
    self.outWorkCount.text = [NSString stringWithFormat:@"出差:%@人",companyWeekModel.outWorkCount];
}
