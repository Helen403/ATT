...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[ContrastCellView class] forCellReuseIdentifier:[NSString stringWithUTF8String:object_getClassName([ContrastCellView class])]];
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    return self.checkViewModel.arrContrast.count;
}
