...
@implementation TeamMonthCellView
...
-(void)setTeamMonthModel:(TeamMonthModel *)teamMonthModel{
    if (!teamMonthModel) {
        return;
    }
    ...
    self.goOutWorkCount.text = [NSString stringWithFormat:@"外出:%@人",teamMonthModel.goOutWorkCount];
    self.offWorkCount.text = [NSString stringWithFormat:@"请假:%@人",teamMonthModel.offWorkCount];
    self.overWorkCount.text = [NSString stringWithFormat:@"加班:%@人",teamMonthModel.overWorkCount];
    self.outWorkCount.text = [NSString stringWithFormat:@"出差:%@人",teamMonthModel.outWorkCount];
}
