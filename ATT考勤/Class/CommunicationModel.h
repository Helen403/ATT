...
@interface CommunicationModel : NSObject

@property (nonatomic , copy) NSString              * position;
@property (nonatomic , copy) NSString              * fullTimeCultural;
@property (nonatomic , copy) NSString              * empNation;
@property (nonatomic , copy) NSString              * empProvice;
@property (nonatomic , copy) NSString              * empBirthDate;
@property (nonatomic , copy) NSString              * empPhotos;
@property (nonatomic , copy) NSString              * empQQ;
@property (nonatomic , copy) NSString              * empEmail;
@property (nonatomic , copy) NSString              * isMarriage;
