...
-(UITableView *)tableView{
    if (!_tableView) {
        ...
        [_tableView registerClass:[ListCellView class] forCellReuseIdentifier:[NSString stringWithUTF8String:object_getClassName([ListCellView class])]];
    }
    return _tableView;
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section{
    ...
    return self.checkViewModel.arrList.count;
}
