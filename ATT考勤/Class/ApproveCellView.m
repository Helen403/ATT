...
@implementation ApproveCellView
...
-(void)setApproveModel:(ApproveModel *)approveModel{
    if (!approveModel) {
        return;
    }
    _approveModel = approveModel;

    self.Img.image = ImageNamed(approveModel.imgtext);
    self.title.text = approveModel.title;
    self.number.text = approveModel.number;
