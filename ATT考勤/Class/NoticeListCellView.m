...
@implementation NoticeListCellView
...
-(void)setNoticeListModel:(NoticeListModel *)noticeListModel{
    ...
    self.time.text = noticeListModel.msgPublishDate;
    self.team.text = noticeListModel.msgOffice;
    
    if ([noticeListModel.msgStatus isEqualToString:@"0"]) {
        self.state.text = @"未阅读";
    ...
    self.content.text = noticeListModel.msgTitle;
