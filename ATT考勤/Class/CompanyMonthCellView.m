...
@interface CompanyMonthCellView()
...
@implementation CompanyMonthCellView
...
-(void)setCompanyMonthModel:(CompanyMonthModel *)companyMonthModel{
    if (!companyMonthModel) {
        return;
    }
    _companyMonthModel = companyMonthModel;
    self.time.text =[NSString stringWithFormat:@"%@",[LSCoreToolCenter getFormatterYM:companyMonthModel.week]];
    self.team.text = [NSString stringWithFormat:@"%@",companyMonthModel.deptName];
    self.attend.text = [NSString stringWithFormat:@"出勤率为%.2f%%",companyMonthModel.normalRate.floatValue] ;
    self.lateWorkCount.text = [NSString stringWithFormat:@"迟到:%@人",companyMonthModel.lateWorkCount];
    self.earlyWorkCount.text = [NSString stringWithFormat:@"早退:%@人",companyMonthModel.earlyWorkCount];
    self.forgetWorkCount.text = [NSString stringWithFormat:@"漏打卡:%@人",companyMonthModel.forgetWorkCount];
    self.goOutWorkCount.text = [NSString stringWithFormat:@"外出:%@人",companyMonthModel.goOutWorkCount];
    self.offWorkCount.text = [NSString stringWithFormat:@"请假:%@人",companyMonthModel.offWorkCount];
    self.overWorkCount.text = [NSString stringWithFormat:@"加班:%@人",companyMonthModel.overWorkCount];
    self.outWorkCount.text = [NSString stringWithFormat:@"出差:%@人",companyMonthModel.outWorkCount];
}
