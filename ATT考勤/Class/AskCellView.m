...
-(void)setAskModel:(AskModel *)askModel{
    if (!askModel) {
        return;
    }
    _askModel = askModel;

    self.Img.image = ImageNamed(askModel.imgtext);
    self.title.text = askModel.title;
    self.number.text = askModel.number;
