...
@interface CompanyDailyCellView()
...
@implementation CompanyDailyCellView
...
-(void)setCompanyDailyModel:(CompanyDailyModel *)companyDailyModel{
    if (!companyDailyModel) {
        return;
    }
    _companyDailyModel = companyDailyModel;
    self.time.text = [LSCoreToolCenter getFormatterYMD:companyDailyModel.busDate];
    self.team.text = [NSString stringWithFormat:@"%@(%@人)",companyDailyModel.deptName,companyDailyModel.deptPersonCount] ;
    self.attend.text =[NSString stringWithFormat:@"出勤率为%.2f%%",companyDailyModel.normalRate.floatValue] ;
    self.lateWorkCount.text = [NSString stringWithFormat:@"迟到:%@人",companyDailyModel.lateWorkCount];
    self.earlyWorkCount.text = [NSString stringWithFormat:@"早退:%@人",companyDailyModel.earlyWorkCount];
    self.forgetWorkCount.text = [NSString stringWithFormat:@"漏打卡:%@人",companyDailyModel.forgetWorkCount];
    self.goOutWorkCount.text = [NSString stringWithFormat:@"外出:%@人",companyDailyModel.goOutWorkCount];
    self.offWorkCount.text = [NSString stringWithFormat:@"请假:%@人",companyDailyModel.offWorkCount];
    self.overWorkCount.text = [NSString stringWithFormat:@"加班:%@人",companyDailyModel.overWorkCount];
    self.outWorkCount.text = [NSString stringWithFormat:@"出差:%@人",companyDailyModel.outWorkCount];
}
