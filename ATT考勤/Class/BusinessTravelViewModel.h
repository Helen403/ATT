...
@interface BusinessTravelViewModel : HViewModel
...
//===========================================
@property(nonatomic,strong) RACCommand *applyOutWorkCommand;
...
@property(nonatomic,strong) NSString *outFinaceType;
